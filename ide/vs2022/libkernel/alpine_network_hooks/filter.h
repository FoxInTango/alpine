...
#define FILTER_FRIENDLY_NAME        L"alpine_network_hooks NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{5b3a0d55-9e12-471e-9bb8-7ecb370c0182}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"alpine_network_hooks"

//
// The filter needs to handle IOCTLs
//
#define LINKNAME_STRING             L"\\DosDevices\\alpine_network_hooks"
#define NTDEVICE_STRING             L"\\Device\\alpine_network_hooks"
...
DRIVER_DISPATCH alpinenetworkhooksDispatch;

DRIVER_DISPATCH alpinenetworkhooksDeviceIoControl;
